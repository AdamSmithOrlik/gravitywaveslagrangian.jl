...
# 0.3 GeV from 100-3 risco Mc = 1e3
run0_dictionary = Dict(
    # Name of hdf5 produced 
    :Run_name=>"100_3_risco_Mbh_1e5_Mc_1e3_rho_0_3GeV_full_rel",  
    ...
    # 0.3 GeV
    :rho0=> 5.35e-25 .* 7.071e8, # [g/cm^3 to 1/pc^2] -> Equivalent to 0.3 GeV/cm^3
    # redshift taken from arxiv:1408.3534
    :z_f => 20,
...
run1_dictionary = Dict(
    # Name of hdf5 produced 
    :Run_name=>"100_3_risco_Mbh_1e5_Mc_1e3_rho_0_1GeV_full_rel",  
...
run2_dictionary = Dict(
    # Name of hdf5 produced 
    :Run_name=>"100_3_risco_Mbh_1e5_Mc_1e2_rho_0_5GeV_full_rel",  
